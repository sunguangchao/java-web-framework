...
public class JsonUtil {
    ...
    public static <type> type jsonToObjectList(String json, Class<?> collecitonClass, Class<?>... elementClass){
        type obj = null;
        JavaType javaType = objectMapper.getTypeFactory().constructParametricType(collecitonClass, elementClass);
        try {
            obj = objectMapper.readValue(json, javaType);
        }catch (IOException e){
            throw new IllegalStateException(e.getMessage(), e);
